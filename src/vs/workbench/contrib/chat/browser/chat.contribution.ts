...
import { PlanExecutionTracker, IPlanExecutionTracker } from '../common/planExecutionTracker.js';
...
registerSingleton(IPlanExecutionTracker, PlanExecutionTracker, InstantiationType.Delayed);
